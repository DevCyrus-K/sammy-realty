              ...
              <div class="ltn__car-dealer-form-tab">
                <div class="ltn__tab-menu  text-uppercase d-none">
                  <div class="nav">
                    ...
                    >
                      <i class="fas fa-car"></i>Find A Car
                    </a>
                    <a data-bs-toggle="tab" href="#ltn__form_tab_1_2" class="">
                      <i class="far fa-user"></i>Get a Dealer
                    </a>
                  </div>
                </div>
      ...
      >
        <div class="container">
          ...
          <Slider
            ...
            {...testiMonialsettings}
            class="row ltn__testimonial-slider-5-active slick-arrow-1"
          >
            <div class="col-lg-4">
                  ...
                  <div class="ltn__blog-meta">
                    <ul>
                      ...
                      <li class="ltn__blog-tags">
                        <a href="#">
                          <i class="fas fa-tags"></i>Decorate
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <div class="ltn__blog-brief">
                  <div class="ltn__blog-meta">
                    <ul>
                      ...
                      <li class="ltn__blog-tags">
                        <a href="#">
                          <i class="fas fa-tags"></i>Interior
                        </a>
                      </li>
                    </ul>
                  </div>
