...
function HomeVersion2(props) {
        ...
        <LayoutOne>
            ...
            <div class="ltn__slider-area ltn__slider-11  ltn__slider-11-slide-item-count-show--- ltn__slider-11-pagination-count-show--- section-bg-1">
                <div class="ltn__slider-11-inner position-relative">
                    <Slider asNavFor={nav2} ref={(slider1) => setNav1(slider1)} class="ltn__slider-11-active">
                        {/* <!-- slide-item --> */}
                    ...
                    <div class="ltn__slider-11-img-slide-arrow">
                        <div class="ltn__slider-11-img-slide-arrow-inner">
                            <Slider {...settings} asNavFor={nav1}
                                ...
                                slidesToShow={3}
                                class="ltn__slider-11-img-slide-arrow-active">
    ...
    <!-- UPCOMING PROJECT AREA START --> */}
            <div class="ltn__upcoming-project-area section-bg-1--- bg-image-top pt-115 pb-65" style={{backgroundImage:`url("../img/bg/22.jpg")`}}  >
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title-area ltn__section-title-2--- text-center---">
                    ...
                    <Slider {...upCommingSettings} class="row ltn__upcoming-project-slider-1-active slick-arrow-3">
    ...
    <!-- SEARCH BY PLACE AREA START (testimonial-7) --> */}
            <div class="ltn__search-by-place-area before-bg-top bg-image-top--- pt-115 pb-70" style={{backgroundImage:`url("../img/bg/20.jpg")`}}>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title-area ltn__section-title-2--- text-center---">
 ...
 {/* <Slider
                ...
                {...settings}></Slider> */}
                    ...
                    <Slider {...productsettings} class="row ltn__search-by-place-slider-1-active slick-arrow-1">
                        <div class="col-lg-4">
    ...
    <!-- TESTIMONIAL AREA START (testimonial-8) --> */}
            <div class="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-65" style={{backgroundImage:`url("../img/bg/23.jpg")`}}>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="section-title-area ltn__section-title-2--- text-center---">
                    ...
                    <Slider {...testiMonialsettings} class="row ltn__testimonial-slider-6-active slick-arrow-3">
                        <div class="col-lg-4">
    ...
    <!-- BLOG AREA START (blog-3) --> */}
            <div class="ltn__blog-area pt-115--- pb-70">
                <div class="container">
                    ...
                    <Slider {...blogSettings} class="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                        {/* <!-- Blog Item --> */}
                        <div class="col-lg-12">
