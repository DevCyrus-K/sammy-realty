...
function HomeVersion2(props) {
        ...
        <LayoutOne>
            ...
            <div className="ltn__slider-area ltn__slider-11 section-bg-1">
                <div className="ltn__slider-11-inner position-relative">
                    <Slider asNavFor={nav2} ref={(slider1) => setNav1(slider1)} className="ltn__slider-11-active">
                        {/* <!-- slide-item --> */}
                                        ...
                                        <Col xs={12} className="align-self-center">
                                            <div className="slide-item-info">
                                                <div className="slide-item-info-inner ltn__slide-animation">
                                                    ...
                                                    <h6 className="slide-sub-title animated"><span><i className="fas fa-home"></i></span> Real Estate Agency</h6>
                                                    <h1 className="slide-title animated ">Search and Find <br /><span>Luxury</span> House</h1>
                                                    <div className="slide-brief animated">
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore.</p>
                                                    </div>
                                                    <div className="btn-wrapper animated">
                                                        <a href="about.html" className="theme-btn-1 btn btn-effect-1">Make An Enquiry</a>
                                            ...
                                            <div className="slide-item-info">
                                                <div className="slide-item-info-inner ltn__slide-animation">
                                                    ...
                                                    <div className="btn-wrapper animated">
                                                        ...
                                                        <a href="about.html" className="btn btn-transparent btn-effect-3">LEARN MORE</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="slide-item-img">
                        ...
                        <div className="col-lg-4 col-sm-6 col-12">
                            <div className="ltn__feature-item ltn__feature-item-6 text-center bg-white  box-shadow-1">
                                ...
                                <div className="ltn__feature-info">
                                    ...
                                    <a className="ltn__service-btn" href="service-details.html">Find A Home <i className="flaticon-right-arrow"></i></a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-sm-6 col-12">
    ...
    <!-- UPCOMING PROJECT AREA START --> */}
            <div className="ltn__upcoming-project-area section-bg-1--- bg-image-top pt-115 pb-65" style={{ backgroundImage: `url("../img/bg/22.jpg")` }}  >
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title-area ltn__section-title-2--- text-center---">
                    ...
                    <Slider {...upCommingSettings} className="row ltn__upcoming-project-slider-1-active slick-arrow-3">
                        ...
                        <div className="col-lg-12">
                            ...
                            <div className="ltn__tab-menu ltn__tab-menu-3 ltn__tab-menu-top-right-- text-uppercase--- text-center">
                                <div className="nav">
                                    ...
                                    <a data-bs-toggle="tab" href="#liton_tab_3_3" className="">Penthouse</a>
                                    <a data-bs-toggle="tab" href="#liton_tab_3_4" className="">Top Garden</a>
                                    <a data-bs-toggle="tab" href="#liton_tab_3_5" className="">Double Height</a>
                                </div>
                            </div>
    ...
    <!-- SEARCH BY PLACE AREA START (testimonial-7) --> */}
            <div className="ltn__search-by-place-area before-bg-top bg-image-top--- pt-115 pb-70" style={{ backgroundImage: `url("../img/bg/20.jpg")` }}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title-area ltn__section-title-2--- text-center---">
                ...
                {...settings}></Slider> */}
                    ...
                    <Slider {...productsettings} className="row ltn__search-by-place-slider-1-active slick-arrow-1">
                            ...
                            <div className="ltn__search-by-place-item">
                                ...
                                <div className="search-by-place-info">
                                    ...
                                    <div className="search-by-place-btn">
                                        <a href="product-details">View Property <i className="flaticon-right-arrow"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-12">
                            <div className="ltn__neighbour-tab-wrap">
                                <div className="ltn__tab-menu ltn__tab-menu-3--- ltn__tab-menu-4 ltn__tab-menu-top-right-- text-uppercase--- text-center">
                                    <div className="nav">
                                        <a className="active show" data-bs-toggle="tab" href="#liton_tab_4_1"><img src="../img/neighbour/1.jpg" alt="#" /></a>
                                        <a data-bs-toggle="tab" href="#liton_tab_4_2" className=""><img src="../img/neighbour/2.jpg" alt="#" /></a>
                                        <a data-bs-toggle="tab" href="#liton_tab_4_3" className=""><img src="../img/neighbour/3.jpg" alt="#" /></a>
                                    </div>
                                </div>
                                <div className="tab-content">
                                        ...
                                        <div id="accordion_2">
                                            ...
                                            <div className="card">
                                                <h6 className="collapsed ltn__card-title" data-bs-toggle="collapse" data-bs-target="#faq-item-2-1" aria-expanded="false">
                                                    <i className="flaticon-mortarboard"></i> University / College
                                                </h6>
                    ...
                    <div className="row ltn__category-slider-active--- slick-arrow-1 justify-content-center">
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-car"></i></span>
                                    ...
                                    <span className="category-btn d-none"><i className="flaticon-right-arrow"></i></span>
                                </a>
                            </div>
                        </div>
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-swimming"></i></span>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-secure-shield"></i></span>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-stethoscope"></i></span>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-book"></i></span>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-bed-1"></i></span>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-home-2"></i></span>
                        ...
                        <div className="col-lg-3 col-md-4 col-sm-6 col-6">
                            <div className="ltn__category-item ltn__category-item-5 ltn__category-item-5-2 text-center---">
                                <a href="shop.html">
                                    <span className="category-icon"><i className="flaticon-slider"></i></span>
    ...
    <!-- TESTIMONIAL AREA START (testimonial-8) --> */}
            <div className="ltn__testimonial-area section-bg-1--- bg-image-top pt-115 pb-65" style={{ backgroundImage: `url("../img/bg/23.jpg")` }}>
                <div className="container">
                    <div className="row">
                        <div className="col-lg-12">
                            <div className="section-title-area ltn__section-title-2--- text-center---">
                    ...
                    <Slider {...testiMonialsettings} className="row ltn__testimonial-slider-6-active slick-arrow-3">
                        <div className="col-lg-4">
    ...
    <!-- BLOG AREA START (blog-3) --> */}
            <div className="ltn__blog-area pt-115--- pb-70">
                <div className="container">
                    ...
                    <Slider {...blogSettings} className="row  ltn__blog-slider-one-active slick-arrow-1 ltn__blog-item-3-normal">
                        {/* <!-- Blog Item --> */}
                        <div className="col-lg-12">
                                    ...
                                    <div className="ltn__blog-meta">
                                        <ul>
                                            ...
                                            <li className="ltn__blog-tags">
                                                <a href="#"><i className="fas fa-tags"></i>Decorate</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="ltn__blog-brief">
                                    <div className="ltn__blog-meta">
                                        <ul>
                                            ...
                                            <li className="ltn__blog-tags">
                                                <a href="#"><i className="fas fa-tags"></i>Interior</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="ltn__blog-brief">
                                    <div className="ltn__blog-meta">
                                        <ul>
                                            ...
                                            <li className="ltn__blog-tags">
                                                <a href="#"><i className="fas fa-tags"></i>Estate</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="ltn__blog-brief">
                                    <div className="ltn__blog-meta">
                                        <ul>
                                            ...
                                            <li className="ltn__blog-tags">
                                                <a href="#"><i className="fas fa-tags"></i>Room</a>
                                            </li>
                                        </ul>
                                    </div>
                                ...
                                <div className="ltn__blog-brief">
                                    <div className="ltn__blog-meta">
                                        <ul>
                                            ...
                                            <li className="ltn__blog-tags">
                                                <a href="#"><i className="fas fa-tags"></i>Trends</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div className="col-lg-12">
                            <div className="call-to-action-inner call-to-action-inner-6 ltn__secondary-bg position-relative text-center---">
                                ...
                                <div className="btn-wrapper">
                                    <a className="btn btn-effect-3 btn-white" href="contact.html">Explore Properties <i className="icon-next"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
