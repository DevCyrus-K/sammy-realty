...
import {
  FaDribbble, FaInstagram, FaTwitter, FaFacebookF, FaCheck
} from "react-icons/fa";
                  ...
                  <div className="ltn__page-details-inner ltn__blog-details-inner">
                    ...
                    <div className="ltn__blog-meta">
                      <ul>
                        <li className="ltn__blog-author">
                          <Link href="#"><img src={`/img/blog/${blog.author.img}`} alt="#" />By: {blog.author.name}</Link>
                        </li>
                        ...
                        <li>
                          <Link href="#"><i className="far fa-comments"></i>
                            <span>{blog.comments}</span> Comments</Link>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="list-item-with-icon-2">
                      <ul>
                        {blog.extraInformationList.map((single, key) => {
                          return <li key={key}> <span className="me-2"><FaCheck /></span> {single.name}</li>
                        })}

                      </ul>
                    </div>
                    <blockquote>
                      <h6 className="ltn__secondary-color mt-0">BY {blog.blockquote.name}</h6>
                    ...
                    <div className="row">
                      <div className="col-lg-6">
                        <img src={`/img/service/${blog.extraContent.caption.img1}`} alt="Image" />
                        <label>{blog.extraContent.caption.imageCaption}</label>
                      </div>
                      <div className="col-lg-6">
                        <img src={`/img/service/${blog.extraContent.caption.img2}`} alt="Image" />
                      </div>
                    </div>
                  ...
                  <div className="related-post-area mb-50">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        ...
                        <div className="ltn__blog-item ltn__blog-item-6">
                          <div className="ltn__blog-img">
                            <Link href="blog-details.html"><img src="img/blog/blog-details/11.jpg" alt="Image" /></Link>
                          </div>
                          <div className="ltn__blog-brief">
                            ...
                            <h3 className="ltn__blog-title"><Link href="blog-details.html">A series of iOS 7 inspire
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="ltn__blog-item ltn__blog-item-6">
                          <div className="ltn__blog-img">
                            <Link href="blog-details.html"><img src="img/blog/blog-details/12.jpg" alt="Image" /></Link>
                          </div>
                          <div className="ltn__blog-brief">
                            <div className="ltn__blog-meta">
                              <ul>
                        ...
                        <li>
                          <div className="ltn__comment-item clearfix">
                            ...
                            <div className="ltn__commenter-comment">
                              <h6><Link href="#">Adam Smit</Link></h6>
                              <span className="comment-date">20th May 2020</span>
                              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloribus, omnis fugit corporis iste magnam ratione.</p>
                              <Link href="#" className="ltn__comment-reply-btn"><i className="icon-reply-1"></i>Reply</Link>
                            </div>
                          </div>
                          <ul>
                            <li>
